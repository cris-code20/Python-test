...
def test_perfilUser():
    ...
    driver.find_element(By.ID, "mainMenuSearch").send_keys("diseño")
    
    driver.find_element(By.CLASS_NAME, "a-icon-star fa-fw").click()
    
    driver.save_screenshot('./data/reproducir.jpg')
